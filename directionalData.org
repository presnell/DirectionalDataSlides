...
datafile <- paste(datadir, "vertebrae-superior-facet.txt", sep="")
vertebrae <- read.table(datafile, header=TRUE)
...
#+BEGIN_SRC R :exports none
datafile <- paste(datadir, "butterfly.txt", sep="")
butterflies <- read.table(datafile, header=TRUE)
#+END_SRC
